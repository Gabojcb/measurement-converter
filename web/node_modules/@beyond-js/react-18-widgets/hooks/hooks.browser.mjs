...
import * as dependency_2 from '@beyond-js/kernel/texts';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/react-18-widgets@1.0.3/hooks"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./index', {hash: 1265547908, creator: function (require, exports) {
"use strict";
...
ims.set('./use-texts', {hash: 2544629518, creator: function (require, exports) {
"use strict";
...
/*bundle*/function useTexts(specifier, key) {
...
__pkg.exports.descriptor = [{"im":"./index","from":"useBinder","name":"useBinder"},{"im":"./use-texts","from":"useTexts","name":"useTexts"}];

export let useBinder, useTexts;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'useBinder') && (useBinder = require ? require('./index').useBinder : value);
    (require || prop === 'useTexts') && (useTexts = require ? require('./use-texts').useTexts : value);
