System.register(["@beyond-js/kernel/bundle", "react", "@beyond-js/kernel/texts"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, __Bundle, __pkg, ims, useBinder, useTexts, __beyond_pkg, hmr;
  _export({
    useBinder: void 0,
    useTexts: void 0
  });
  return {
    setters: [function (_beyondJsKernelBundle) {
      ...
      dependency_1 = _react;
    }, function (_beyondJsKernelTexts) {
      dependency_2 = _beyondJsKernelTexts;
    }],
    execute: function () {
      ({
        Bundle: __Bundle
